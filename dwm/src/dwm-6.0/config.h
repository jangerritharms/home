...
static const char colors[NUMCOLORS][ColLast][8] = {
    ...
    { "#93a1a1", "#657b83", "#fdf6e3" },  // normal
    { "#586e75", "#eee8d5", "#93a1a1" },  // selected
    { "#93a1a1", "#b58900", "#fdf6e3" },  // urgent/warning  (black on yellow)
    { "#dc322f", "#657b83", "#fdf6e3" },  // error (white on red)
};
static const unsigned int borderpx  = 2;        /* border pixel of windows */
static const unsigned int snap      = 32;       /* snap pixel */
static const Bool showbar           = True;     /* False means no bar */
static const Bool topbar            = True;     /* False means bottom bar */
static const Bool statusmarkup      = True;     /* True means use pango markup in status messages */

/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "8", "9" };

static const Rule rules[] = {
	/* class      instance    title       tags mask     isfloating   monitor */ { "Gimp",     NULL,       NULL,       0,            True,        -1 },
...
static Key keys[] = {
    ...
    { 0,                            0x1008ff13, spawn,         {.v = raisevol } },
    { 0,                            0x1008ff11, spawn,         {.v = lowervol } },
    { 0,                            0x1008ff12, spawn,         {.v = mute } }, 
    { 0,                            0x1008ff03, spawn,         {.v = dimmer } },
    { 0,                            0x1008ff02, spawn,         {.v = brighter } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
